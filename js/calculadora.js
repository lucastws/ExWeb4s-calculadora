		...
		else
		{
			if(btn.value == '%')
			{
				...
				{	
					if(Calculadora.operacoes.operacao == '/')
					{ 
						if(Calculadora.numeros.num2 == null) Calculadora.numeros.total = Calculadora.display(Calculadora.numeros.num1 / ((Calculadora.numeros.num1/100)*2));
...
function btnIgual_Click(btn) 
{
	if(Calculadora.acoes.on == true)
	{
		...
		else Calculadora.operacoes.permitir = true;
	}
}